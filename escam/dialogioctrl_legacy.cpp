/*****************************************************************//**
 * @file   DialogIoctrlLegacy.cpp
 * @copydoc DialogIoctrlLegacy.h
 *********************************************************************/
	...
	ui(new Ui::DialogIoctrlLegacy)
{
	...
	connect(ui->spinBoxO1D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO2D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO3D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO4D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO5D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO6D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO7D, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO1W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO2W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO3W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO4W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO5W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO6W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);
	connect(ui->spinBoxO7W, qOverload<int>(&QSpinBox::valueChanged), this, &DialogIoctrlLegacy::spinBox_valueChanged);

	connect(ui->doubleSpinBoxT0, qOverload<double>(&QDoubleSpinBox::valueChanged), this, &DialogIoctrlLegacy::setT0);
...
void DialogIoctrlLegacy::setT0(uint32_t period_in_10ns)
{
	uint32_t drvno = ui->spinBoxBoard->value();
...
void DialogIoctrlLegacy::spinBox_valueChanged() {
	uint32_t drvno = ui->spinBoxBoard->value();
	// Save output values
	settings.beginGroup("board" + QString::number(drvno));
...
void DialogIoctrlLegacy::on_pushButtonDefault_pressed()
{
	uint32_t drvno = ui->spinBoxBoard->value();
	// Save output values
	settings.beginGroup("board" + QString::number(drvno));
...
void DialogIoctrlLegacy::on_spinBoxBoard_valueChanged()
{
	uint32_t drvno = ui->spinBoxBoard->value();
	settings.beginGroup("board" + QString::number(drvno));
	//save old values
