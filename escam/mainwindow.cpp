...
void MainWindow::startPressed()
{
	...
	settings_struct.dac_output[1][0] = settings.value(settingSensorOffsetBoard2Channel1Path, settingSensorOffsetChannel1Default).toInt();
    settings_struct.dac_output[1][1] = settings.value(settingSensorOffsetBoard2Channel2Path, settingSensorOffsetChannel2Default).toInt();
    settings_struct.dac_output[1][2] = settings.value(settingSensorOffsetBoard2Channel3Path, settingSensorOffsetChannel3Default).toInt();
    settings_struct.dac_output[1][3] = settings.value(settingSensorOffsetBoard2Channel4Path, settingSensorOffsetChannel4Default).toInt();
    settings_struct.dac_output[1][4] = settings.value(settingSensorOffsetBoard2Channel5Path, settingSensorOffsetChannel5Default).toInt();
    settings_struct.dac_output[1][5] = settings.value(settingSensorOffsetBoard2Channel6Path, settingSensorOffsetChannel6Default).toInt();
    settings_struct.dac_output[1][6] = settings.value(settingSensorOffsetBoard2Channel7Path, settingSensorOffsetChannel7Default).toInt();
    settings_struct.dac_output[1][7] = settings.value(settingSensorOffsetBoard2Channel8Path, settingSensorOffsetChannel8Default).toInt();
