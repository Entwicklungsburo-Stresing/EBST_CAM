...
NumericConverterWidget::~NumericConverterWidget()
{
	delete ui;
}

void NumericConverterWidget::setDecimal(QString dec)
{
	ui->lineEditDec->setText(dec);
	return;
}

QString NumericConverterWidget::getDecimal()
{
	return ui->lineEditDec->text();
}

void NumericConverterWidget::setHex(QString hex)
{
	ui->lineEditHex->setText(hex);
	return;
}

QString NumericConverterWidget::getHex()
{
	return ui->lineEditHex->text();
}

void NumericConverterWidget::setBinary(QString bin)
{
	ui->lineEditBin->setText(bin);
	return;
}

QString NumericConverterWidget::getBinary()
{
	return ui->lineEditBin->text();
}

void NumericConverterWidget::setSequenceLength(int len)
{
	ui->spinBoxSeqLength->setValue(len);
	return;
}

QString NumericConverterWidget::getSequenceLength()
{
	return QString::number(ui->spinBoxSeqLength->value());
}

void NumericConverterWidget::on_spinBoxSeqLength_valueChanged(int val)
{
...
void NumericConverterWidget::on_lineEditHex_textChanged()
{
...
void NumericConverterWidget::on_lineEditBin_textChanged()
{
...
void NumericConverterWidget::on_lineEditBin_editingFinished() {
	ui->lineEditBin->blockSignals(true);
	QString bin = ui->lineEditBin->text();
	ui->lineEditBin->setText(addLeadingZerosToBin(bin));
	ui->lineEditBin->blockSignals(false);
...
QString NumericConverterWidget::convertDecimalToBinary(QString decimal)
{
...
QString NumericConverterWidget::convertHexToBinary(QString hex)
{
...
QString NumericConverterWidget::convertBinaryToDecimal(QString binary)
{
...
QString NumericConverterWidget::convertBinaryToHex(QString binary)
{
	if (binary.isEmpty()) {
		return QString("0");
	}
...
QString NumericConverterWidget::addLeadingZerosToBin(QString bin)
{
