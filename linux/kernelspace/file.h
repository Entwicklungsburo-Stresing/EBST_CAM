...
ssize_t lscpcie_write(struct file *filp, const char __user *buf, size_t len, loff_t *off);
ssize_t lscpcie_read(struct file *filp, char __user *buf, size_t len, loff_t *off);
