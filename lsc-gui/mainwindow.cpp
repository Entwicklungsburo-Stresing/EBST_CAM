...
void MainWindow::on_actionDump_board_registers_triggered()
{
    ...
    labelS0->setText(QString::fromStdString(lsc._dumpS0Registers(1)));
    ...
    labelDma->setText(QString::fromStdString(lsc._dumpDmaRegisters(1)));
    ...
    labelTlp->setText(QString::fromStdString(lsc._dumpTlp(1)));
