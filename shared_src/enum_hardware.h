...
enum camera_register_addresses_t
{
	...
	/**
	 * sen_tg_1st_half_length controls the length of the first part of the transfer gate (TG) pulse of the high speed camera. The first part is when TG is 1 and P1H is 0. The register is a 16 bit value. The step size depends on the CLK_SEL setting of the hardware switch. The default of this register is 0, which produces the default length of the TG pulse. Added in P209.20.
...
enum ioctrl_register_address_t
{
	 ...
	 */
	ioctrl_shutter = 0x11,
	ioctrl_ch1_base_address = 0x20,
	ioctrl_ch1_binSeq_len = 0x20,
	ioctrl_ch1_binSeq_seg1 = 0x21,
	ioctrl_ch1_binSeq_seg2 = 0x22,
	ioctrl_ch1_binSeq_seg3 = 0x23,
	ioctrl_ch1_binSeq_seg4 = 0x24,
	ioctrl_ch1_binSeq_seg5 = 0x25,
	ioctrl_ch1_binSeq_seg6 = 0x26,
	ioctrl_ch1_binSeq_seg7 = 0x27,
	ioctrl_ch1_binSeq_seg8 = 0x28,
	ioctrl_ch1_pls_delay = 0x29,
	ioctrl_ch1_pls_length = 0x2A,
	ioctrl_ch2_base_address = 0x2B,
	ioctrl_ch2_binSeq_len = 0x2B,
	ioctrl_ch2_binSeq_seg1 = 0x2C,
	ioctrl_ch2_binSeq_seg2 = 0x2D,
	ioctrl_ch2_binSeq_seg3 = 0x2E,
	ioctrl_ch2_binSeq_seg4 = 0x2F,
	ioctrl_ch2_binSeq_seg5 = 0x30,
	ioctrl_ch2_binSeq_seg6 = 0x31,
	ioctrl_ch2_binSeq_seg7 = 0x32,
	ioctrl_ch2_binSeq_seg8 = 0x33,
	ioctrl_ch2_pls_delay = 0x34,
	ioctrl_ch2_pls_length = 0x35,
	ioctrl_ch3_base_adress = 0x36,
	ioctrl_ch3_binSeq_len = 0x36,
	ioctrl_ch3_binSeq_seg1 = 0x37,
	ioctrl_ch3_binSeq_seg2 = 0x38,
	ioctrl_ch3_binSeq_seg3 = 0x39,
	ioctrl_ch3_binSeq_seg4 = 0x3A,
	ioctrl_ch3_binSeq_seg5 = 0x3B,
	ioctrl_ch3_binSeq_seg6 = 0x3C,
	ioctrl_ch3_binSeq_seg7 = 0x3D,
	ioctrl_ch3_binSeq_seg8 = 0x3E,
	ioctrl_ch3_pls_delay = 0x3F,
	ioctrl_ch3_pls_length = 0x40,
	ioctrl_ch4_base_address = 0x41,
	ioctrl_ch4_binSeq_len = 0x41,
	ioctrl_ch4_binSeq_seg1 = 0x42,
	ioctrl_ch4_binSeq_seg2 = 0x43,
	ioctrl_ch4_binSeq_seg3 = 0x44,
	ioctrl_ch4_binSeq_seg4 = 0x45,
	ioctrl_ch4_binSeq_seg5 = 0x46,
	ioctrl_ch4_binSeq_seg6 = 0x47,
	ioctrl_ch4_binSeq_seg7 = 0x48,
	ioctrl_ch4_binSeq_seg8 = 0x49,
	ioctrl_ch4_pls_delay = 0x4A,
	ioctrl_ch4_pls_length = 0x4B,
	ioctrl_ch5_base_address = 0x4C,
	ioctrl_ch5_binSeq_len = 0x4C,
	ioctrl_ch5_binSeq_seg1 = 0x4D,
	ioctrl_ch5_binSeq_seg2 = 0x4E,
	ioctrl_ch5_binSeq_seg3 = 0x4F,
	ioctrl_ch5_binSeq_seg4 = 0x50,
	ioctrl_ch5_binSeq_seg5 = 0x51,
	ioctrl_ch5_binSeq_seg6 = 0x52,
	ioctrl_ch5_binSeq_seg7 = 0x53,
	ioctrl_ch5_binSeq_seg8 = 0x54,
	ioctrl_ch5_pls_delay = 0x55,
	ioctrl_ch5_pls_length = 0x56,
	ioctrl_ch6_base_address = 0x57,
	ioctrl_ch6_binSeq_len = 0x57,
	ioctrl_ch6_binSeq_seg1 = 0x58,
	ioctrl_ch6_binSeq_seg2 = 0x59,
	ioctrl_ch6_binSeq_seg3 = 0x5A,
	ioctrl_ch6_binSeq_seg4 = 0x5B,
	ioctrl_ch6_binSeq_seg5 = 0x5C,
	ioctrl_ch6_binSeq_seg6 = 0x5D,
	ioctrl_ch6_binSeq_seg7 = 0x5E,
	ioctrl_ch6_binSeq_seg8 = 0x5F,
	ioctrl_ch6_pls_delay = 0x60,
	ioctrl_ch6_pls_length = 0x61,
	ioctrl_ch7_base_address = 0x62,
	ioctrl_ch7_binSeq_len = 0x62,
	ioctrl_ch7_binSeq_seg1 = 0x63,
	ioctrl_ch7_binSeq_seg2 = 0x64,
	ioctrl_ch7_binSeq_seg3 = 0x65,
	ioctrl_ch7_binSeq_seg4 = 0x66,
	ioctrl_ch7_binSeq_seg5 = 0x67,
	ioctrl_ch7_binSeq_seg6 = 0x68,
	ioctrl_ch7_binSeq_seg7 = 0x69,
	ioctrl_ch7_binSeq_seg8 = 0x6A,
	ioctrl_ch7_pls_delay = 0x6B,
	ioctrl_ch7_pls_length = 0x6C,
	ioctrl_ch8_base_address = 0x6D,
	ioctrl_ch8_binSeq_len = 0x6D,
	ioctrl_ch8_binSeq_seg1 = 0x6E,
	ioctrl_ch8_binSeq_seg2 = 0x6F,
	ioctrl_ch8_binSeq_seg3 = 0x70,
	ioctrl_ch8_binSeq_seg4 = 0x71,
	ioctrl_ch8_binSeq_seg5 = 0x72,
	ioctrl_ch8_binSeq_seg6 = 0x73,
	ioctrl_ch8_binSeq_seg7 = 0x74,
	ioctrl_ch8_binSeq_seg8 = 0x75,
	ioctrl_ch8_pls_delay = 0x76,
	ioctrl_ch8_pls_length = 0x77,
};
