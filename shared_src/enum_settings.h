...
enum tor_out_t
{
	...
	tor_asls = 4,
	/**
	 * stimer is the internal trigger for the start of a readout when @ref camera_settings.sti_mode is set to @ref sti_mode_t.sti_STimer. The repetition rate is determined by @ref camera_settings.stime.
	 */
	tor_stimer = 5,
	/**
